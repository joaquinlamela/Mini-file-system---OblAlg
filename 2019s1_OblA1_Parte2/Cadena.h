...
public:
	...
	ListaPos<Cadena>* split(const char* token);

	Cadena cadenaDesdePos(unsigned int posLinea);

	Cadena cadenaHastaPos(unsigned int posLinea);

	void EliminarEnCadena(unsigned int posLinea, unsigned int k);
