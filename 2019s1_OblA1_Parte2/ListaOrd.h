...
public:
	...
	// POS: Retorna el primer elemento que sea igual a e
	//		Usa el operador == del elemento e para encontrar uno igual
	//		(Es Insegura ya que permite modifiar el dato externamente y 
	//		eso puede hacer que la lista quede desordenada. Usar con cuidado)
	virtual T& RecuperarInseguro(const T&) const abstract;
